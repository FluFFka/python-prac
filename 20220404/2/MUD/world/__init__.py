...
class World:
    ...
    def add_monster(self, name, hp, x, y):
        ...
        :param hp: number of hit points of new monster
        :param x:
        :param y: coordinates of new monster
        """
    ...
    def move(self, direction):
        ...
        :param direction: direction of movement, must be 'up', 'down', 'left' or 'right'
        """
    ...
    def attack(self, name):
        ...
        :param name: name of monster to attack
        """
